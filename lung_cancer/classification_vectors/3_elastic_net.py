...
LOG_FILE = '../log/lung_cancer_vectors_optimized_elasticnet.log'
RESULTS_FILE = '../log/lung_cancer_vectors_elasticnet_results.dill'
...
vector_optim = dill.load(open('../log/lung_cancer_vectors_parameter_optim_elesticnet.dill', 'rb'))
