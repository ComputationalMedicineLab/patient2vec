...
COUNTS_FILE = '../data/intermediate/lung_cancer_raw_counts.dill'
PATIENT_LIST = '../data/intermediate/patient_list_split.csv'
DATA_OUTPUT_FILE = '../data/final/counts/lung_cancer_counts.dill'
...
for months_before in MONTHS_BEFORE:
    ...
    dict_vectorizers[months_before] = DictVectorizer(dtype=np.int, sparse=False)
