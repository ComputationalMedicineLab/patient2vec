...
--  - Patient has no mention of any medication (not complete) from ATC group
--    A10B before first complete record of A10B medication
-- Columns:
--  - ind_seq
...
SELECT * FROM p2v_diabetes_drug_patients; -- 11,208 rows
