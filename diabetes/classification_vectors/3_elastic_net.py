...
LOG_FILE = '../log/diabetes_vectors_optimized_elasticnet.log'
RESULTS_FILE = '../log/diabetes_vectors_elasticnet_results.dill'
...
vector_optim = dill.load(open('../log/diabetes_vectors_parameter_optim_elesticnet.dill', 'rb'))
