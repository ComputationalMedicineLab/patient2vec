...
LOG_FILE = '../log/lung_cancer_counts_monthly_optimized_xgb.log'
RESULTS_FILE = '../log/lung_cancer_counts_monthly_optimized_results.dill'
N_JOBS = 30

rand_search = dill.load(open('../log/lung_cancer_counts_parameter_monthly_optim_xgb.dill', 'rb'))
