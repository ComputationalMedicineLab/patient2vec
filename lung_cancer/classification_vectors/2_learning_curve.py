...
np.random.seed(1)
TRAINING_SAMPLE_SIZES = [10, 50, 100, 250, 500, 750, 1000, 1500, 2000, 3000, 4000, 5000]
TRAINING_FOR_EACH_SIZE = 10
MONTHS = 0

DATA_FILE = '../data/final/vectors/vectors_patient2vec_pvdbow_hs_win-50_emb-300.dill'
LOG_FILE = '../log/lung_cancer_vectors_simple_learning_curves.log'
N_JOBS = 30
N_ESTIMATORS = 2000
